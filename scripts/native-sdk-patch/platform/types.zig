...
pub const Event = union(enum) {
    ...
    /// Documents delivered at launch or while running by the open-
    /// document AppleEvent (Finder double-click, Open With, `open -a
    /// App file`): NUL-split paths from the mac host, same shape as
    /// `files_dropped`.
    open_files: FileDropEvent,
