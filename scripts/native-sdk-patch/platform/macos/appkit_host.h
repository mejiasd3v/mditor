...
typedef enum {
    ...
    NATIVE_SDK_APPKIT_EVENT_OPEN_FILES = 21,
...
/* Open-document AppleEvent (Finder double-click, Open With, `open -a App file`):
 * emits an OPEN_FILES event carrying the NUL-joined UTF-8 paths. */
